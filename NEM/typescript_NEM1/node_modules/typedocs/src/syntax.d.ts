...
declare module Main {
     ...
     */
    interface ContainerElement<T extends Element> extends Element {
        /**
     ...
     */
    interface HeritageClause extends Element {
        /**
     ...
     */
    interface Generic extends Element {
        /**
     ...
     */
    interface VariableDeclaration extends TypedElement {
    }
    /**
     * Defines an element that may be optional.
     */
    interface CanBeOptional {
        /**
     ...
     */
    interface Parameter extends TypedElement, CanBeOptional {
        /**
     ...
     * defines a function.
     */
    interface FunctionDeclaration extends TypedElement, Generic {
        /**
     ...
     */
    interface ItemWithAccessibilityModifiers {
        /**
     ...
     */
    interface MemberInfo extends TypedElement, CanBeOptional, ItemWithAccessibilityModifiers {
    }
    /**
     * Defines a property on a class or interface.
     */
    interface PropertyInfo extends MemberInfo, CanBeAbstract {
    }
    /**
     * Defines a method on a class or interface.
     */
    interface MethodInfo extends MemberInfo, Generic, CanBeAbstract {
        /**
         * The parameters of the function.
         */
        parameters: Parameter[];
     ...
     */
    interface IndexSignature extends TypedElement {
        /**
     ...
     */
    interface Inheritable extends Element {
        /**
     ...
     */
    interface ClassOrInterfaceLikeDeclaration extends ContainerElement<MemberInfo>, Generic, Inheritable {
    }
    /**
     * Defines a class.
     */
    interface ClassDeclaration extends ClassOrInterfaceLikeDeclaration, CanBeAbstract {
    }
    /**
     * Defines an interface.
     */
    interface InterfaceDeclaration extends ClassOrInterfaceLikeDeclaration {
        /**
         * Defines an index signature.
         */
     ...
     */
    interface TypeAliasDeclaration extends TypedElement, Generic {
    }
    /**
     * Defines an enum.
     */
    interface EnumDeclaration extends ContainerElement<EnumMember> {
        /**
     ...
     */
    interface EnumMember extends ValueElement {
    }
    /**
     * Defines a module.
     */
    interface ModuleDeclaration extends ContainerElement<Element> {
        /**
         * The parent module.
         */
