...
describe("Interface", function () {
    ...
    const testInterface = elements[0];
    ...
    const callSignatureOne = testInterface.members[0];
    ...
    const callSignatureTwo = testInterface.members[1];
    ...
    const numberProperty = testInterface.members[2];
    ...
    const stringMapInterface = elements[1];
