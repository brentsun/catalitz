...
describe("Class", function () {
    ...
    const abstractClass = elements[0];
    ...
    const numberProperty = abstractClass.members[0];
    ...
    const abstractProperty = abstractClass.members[1];
    ...
    const abstractMethod = abstractClass.members[2];
    ...
    const overriddenProperty = derivedClass.members[0];
    ...
    const overriddenMethod = derivedClass.members[1];
    ...
    const nullProperty = testClass.members[0];
    ...
    const undefinedProperty = testClass.members[1];
    ...
    const unionTypeProperty = testClass.members[2];
    it("should generate documentation correctly for undefined property", function () {
    ...
    const stringLiteralProperty = testClass.members[3];
    it("should generate documentation correctly for undefined property", function () {
    ...
    const genericTypeParameterProperty = testClass.members[4];
    it("should generate documentation correctly for undefined property", function () {
