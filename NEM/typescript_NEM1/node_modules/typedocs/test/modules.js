...
describe("Module - AMD/CommonJS modules", function () {
    ...
    const innerModuleOne = elements[0].members[0];
    ...
    const innerModuleTwo = elements[0].members[1];
...
describe("Individual module", function () {
    ...
    it("should generate documentation for individual module", function () {
        ...
        assert.ok(rootName.startsWith("\"") && rootName.endsWith("somemodule.d.ts\""), "root element ends with file name");
    });
});
